...
const CalendarWeek: React.FC = () => {
  ...
  return (
    <>
      <div className="mb-0.5 lg:-mt-3 lg:py-3 lg:mb-6 lg:flex lg:items-end lg:border-b lg:border-neutral-200 lg:sticky lg:top-0 lg:z-10 lg:bg-white/95">
      ...
      <div className="max-lg:px-3 max-lg:-mx-3 max-lg:overflow-clip">
        <div className="flex w-full gap-3">
          {Object.entries(orgEvents).map(([day, events]) => (
            <section className="relative flex-grow w-full lg:max-w-[25%] shrink-0 lg:shrink">
              <div className="sticky top-0 z-20 flex items-center gap-3 max-lg:py-3.5 mb-2 lg:static bg-gradient-to-b from-white/95">
                <Button
                  shape="circle"
                  className="!rounded-md bg-white lg:hidden"
                >
                  <svg
                    width="24"
                    height="24"
