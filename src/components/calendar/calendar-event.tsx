...
const CalendarEvent: React.FC<CalendarEventProps> = ({
  ...
  return (
    <Link
      ...
      to={event.link}
      className="block p-0.5 text-sm card max-lg:grid gap-1 sm:gap-4 max-sm:grid-cols-3 max-lg:grid-cols-3 max-lg:items-center"
    >
      <img
        className="max-lg:h-full aspect-[3/2] object-cover object-center mx-auto max-lg:col-span-1 max-lg:rounded-l-[calc(0.375rem-0.125rem)] lg:rounded-t-[calc(0.375rem-0.125rem)]"
        src={event.img}
      />
      <div className="py-2.5 p-3 space-y-0.5 max-lg:col-span-2">
